...
export class UserRegistrationComponent implements OnInit {
  ...
  error_messages = {
    'nombres': [
      ...
      { type: 'minlength', message: 'Mínimo escribir 3 caracteres.' },
      { type: 'maxlength', message: 'Máximo escribir 30 caracteres.' },
    ...
    'edad': [
      ...
      { type: 'min', message: 'Mínimo escribir 5 años.' },
      { type: 'max', message: 'Máximo escribir 90 años.' },
    ],
    'email': [
  ...
  validRegister(){
    if(this.registrationForm.valid){
      if(this.registrationForm.get('password').value === this.registrationForm.get('confirmPass').value){
        console.log(this.registrationForm.get('condiciones').value)
        if (this.registrationForm.get('condiciones').value === true) {
          return false
        } else {
          return true
        }
